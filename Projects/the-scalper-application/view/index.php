        ...
        <div class="owl-carousel owl-theme home_slider">
            ...
            <div class="owl-item">
                <div class="background_image"
                     style="background-image:url(/assets/images/celine_d.jpg)"></div>
                <div class="home_container">
                    <div class="home_container_inner d-flex flex-column align-items-center justify-content-center">
                        <div class="home_content text-center">
                            <!-- <div class="home_subtitle">Tickets running out</div> -->
                            <div class="home_title text-danger"><h1></h1></div>
                            <div class="home_link"><a href="#">Tickets on sale now</a></div>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="owl-item">
                <div class="background_image"
                     style="background-image:url(/assets/images/davechapelle2.jpg)"></div>
                <div class="home_container">
                    <div class="home_container_inner d-flex flex-column align-items-center justify-content-center">
                        <div class="home_content text-center">
                            <div class="home_title text-info"><h1>Dave Chappelle</h1></div>
                            <div class="home_link"><a href="#">Sold out</a></div>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <!-- Slide 3 -->
            <div class="owl-item">
                <div class="background_image" style="background-image:url(/assets/images/circe.jpg)"></div>
                <div class="home_container">
                    <div class="home_container_inner d-flex flex-column align-items-center justify-content-center">
                        <div class="home_content text-center">
                            <div class="home_title text-white"><h1>Cirque du Soleil</h1></div>
                            <div class="home_link"><a href="#">Tickets on sale now</a></div>
                        </div>
                    </div>
                </div>
            ...
            <!-- Slide 4 -->
            <div class="owl-item">
                <div class="background_image" style="background-image:url(/assets/images/wwe.jpg)"></div>
                <div class="home_container">
                    <div class="home_container_inner d-flex flex-column align-items-center justify-content-center">
                        <div class="home_content text-center">
                            <div class="home_title text-warning"><h1>WWE Wrestlemania</h1></div>
                            <div class="home_link"><a href="#">Tickets on sale now</a></div>
                        </div>
                    </div>
                </div>
            ...
            <div class="owl-item">
                <div class="background_image"
                     style="background-image:url(/assets/images/michaelbuble.jpg)"></div>
                <div class="home_container">
                    <div class="home_container_inner d-flex flex-column align-items-center justify-content-center">
                        <div class="home_content text-center">
                            <div class="home_title text-warning"><h1>Michael Buble</h1></div>
                            <div class="home_link"><a href="#">Tickets on sale now</a></div>
                        </div>
                    </div>
                </div>
...
<div class="featured_album">
    <div class="background_image featured_background"
         style="background-image:url(/assets/images/featured.png)"></div>
    <div class="container">
        <div class="row">
        ...
        <div class="row featured_row row-lg-eq-height">
            ...
            <div class="col-md-6">
                <div class="featured_album_image">
                    ...
                    <div class="background_image"
                         style="background-image:url(/assets/images/featured_album.jpg)"></div>
                ...
                <div class="artist_content">
                    ...
                    <div class="artist_text">
                        <p> In vitae nisi aliquam, scelerisque leo a, volutpat sem. Vivamus rutrum dui fermentum eros
                            hendrerit, id lobortis leo volutpat. Maecenas sollicitudin est in libero pretium interdum.
                            Nullam volutpat dui sem, ac congue purus luctus nec. Curabitur luctus luctus erat, sit amet
                            facilisis quam congue quis. Quisque ornare luctus erat id dignissim. Nullam ac nunc quis ex
                            porttitor luctus.</p>
                        <p>Integer sed facilisis eros. In iaculis rhoncus velit in malesuada. In hac habitasse platea
                            dictumst. Fusce erat ex, consectetur sit amet ornare suscipit, porta et erat. Donec nec nisi
                            in nibh commodo laoreet. Mauris dapibus justo ut feugiat malesuada. Fusce ultricies ante
                            tortor, non vestibulum est feugiat ut.</p>
                    </div>
                    <div class="artist_sig"><img src="/assets/images/sig.png" alt=""></div>
...
<div class="extra">
    <div class="extra_container">
        <div class="background_image" style="background-image:url(/assets/images/extra.jpg)"></div>
        <div class="container">
            <div class="row">
                <div class="col-lg-9">
